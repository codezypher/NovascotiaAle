...
style={{ backgroundImage: "url(/assets/images/add.jpg)" }}
/>
    ...
    <div className="col-lg-5">
      <div className="intro_content">
        ...
        <p className="intro_text">
          ...
          Fusce at eleifend tellus. Ut eleifend dui nunc, non fermentum quam
    ...
    <div className="col">
      <div className="stats_contents">
        ...
        <div className="stats_item d-flex flex-md-row flex-column clearfix">
          <div className="stats_last order-md-1 order-3">
            <div className="stats_last_icon d-flex flex-column align-items-center justify-content-end">
              <img src="assets/images/stats_1.png" alt="" />
            </div>
        ...
        <div className="stats_item d-flex flex-md-row flex-column clearfix">
          <div className="stats_last order-md-1 order-3">
            <div className="stats_last_icon d-flex flex-column align-items-center justify-content-end">
              <img src="assets/images/stats_2.png" alt="" />
            </div>
            <div className="stats_last_content">
        ...
        <div className="stats_item d-flex flex-md-row flex-column clearfix">
          <div className="stats_last order-md-1 order-3">
            <div className="stats_last_icon d-flex flex-column align-items-center justify-content-end">
              <img src="assets/images/stats_3.png" alt="" />
            </div>
            <div className="stats_last_content">
        ...
        <div className="stats_item d-flex flex-md-row flex-column clearfix">
          <div className="stats_last order-md-1 order-3">
            <div className="stats_last_icon d-flex flex-column align-items-center justify-content-end">
              <img src="assets/images/stats_4.png" alt="" />
            </div>
            <div className="stats_last_content">
...
<div className="container">
  <div className="row">
    ...
    <div className="col-lg-3 milestone_col">
      <div className="milestone text-center">
        <div className="milestone_icon">
          <img src="assets/images/milestone_1.png" alt="" />
        </div>
    ...
    <div className="col-lg-3 milestone_col">
      <div className="milestone text-center">
        <div className="milestone_icon">
          <img src="assets/images/milestone_2.png" alt="" />
        </div>
    ...
    <div className="col-lg-3 milestone_col">
      <div className="milestone text-center">
        <div className="milestone_icon">
          <img src="assets/images/milestone_3.png" alt="" />
        </div>
    ...
    <div className="col-lg-3 milestone_col">
      <div className="milestone text-center">
        <div className="milestone_icon">
          <img src="assets/images/milestone_4.png" alt="" />
        </div>
